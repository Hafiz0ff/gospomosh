...
export const MOCK_FAQ: FAQItem[] = [
  ...
  // 2. СОЦИАЛЬНЫЕ ВЫПЛАТЫ И ПОСОБИЯ (2026 ГОД)
  {
    id: "faq-9",
    service_id: "srv-1",
    question: "Кто имеет право на Единое пособие на детей до 17 лет и беременных женщин?",
    answer: "Единое пособие выплачивается семьям с детьми от 0 до 17 лет и беременным женщинам, вставшим на учет на ранних сроках. Главные условия: заявитель и ребенок — граждане РФ, постоянно проживающие в РФ (либо иностранцы с ВНЖ при соблюдении условий), а среднедушевой доход семьи не превышает одного регионального прожиточного минимума. Размер выплаты составляет 50%, 75% или 100% детского прожиточного минимума.",
    sort_order: 9,
    is_active: true
  },
  {
    id: "faq-10",
    service_id: "srv-1",
    question: "Могут ли иностранные граждане с ВНЖ получать детские пособия и выплаты в РФ?",
    answer: "Да, иностранные граждане, постоянно проживающие в РФ на основании Вида на жительство (ВНЖ), имеют право на большинство государственных социальных выплат, включая единовременное пособие при рождении ребенка, ежемесячное пособие по уходу за ребенком до 1.5 лет и пособие по беременности и родам при официальном трудоустройстве.",
    sort_order: 10,
    is_active: true
  },
  {
    id: "faq-11",
    service_id: "srv-1",
    question: "Кому положен Материнский (семейный) капитал и как изменились правила?",
    answer: "Материнский капитал выдается родителям при рождении (усыновлении) ребенка. По правилам, материнский капитал выплачивается только на детей, получивших гражданство РФ по рождению, и только тем родителям, которые на момент рождения ребенка уже являлись гражданами РФ. Сертификат можно использовать на улучшение жилищных условий, образование детей или ежемесячные выплаты до 3 лет.",
    sort_order: 11,
    is_active: true
  },
  {
    id: "faq-12",
    service_id: "srv-1",
    question: "Как рассчитывается пособие по уходу за ребенком до 1.5 лет для работающих граждан?",
    answer: "Для официально трудоустроенных граждан пособие по уходу за ребенком до 1.5 лет составляет 40% от среднего заработка за предыдущие 2 календарных года, но не менее законодательно установленного минимального размера. Важно: выплата пособия сохраняется в полном объеме даже при досрочном выходе родителя на работу на полный день.",
    sort_order: 12,
    is_active: true
  },
  {
    id: "faq-13",
    service_id: "srv-1",
    question: "Что такое «правило нулевого дохода» и имущественный ценз при назначении пособий?",
    answer: "Для назначения Единого пособия все трудоспособные члены семьи должны иметь официальный подтвержденный доход (зарплата, пенсия, стипендия, доход самозанятого) хотя бы в одном месяце расчетного периода, либо иметь уважительную причину его отсутствия (уход за ребенком до 3 лет, инвалидность, очное обучение, официальный статус безработного до 6 месяцев). Также оценивается имущество: квартиры, дома, автомобили.",
    sort_order: 13,
    is_active: true
  },
  {
    id: "faq-14",
    service_id: "srv-1",
    question: "Имеют ли право иностранные граждане, работающие по патенту, на оплату больничных?",
    answer: "Иностранные граждане, временно пребывающие и работающие по патенту или трудовому договору, получают право на оплату больничных листов (пособие по временной нетрудоспособности) при условии, что их работодатели перечисляли за них страховые взносы в Социальный фонд России (СФР) в течение определенного периода (не менее установленного норматива за предыдущий год).",
    sort_order: 14,
    is_active: true
  }
];
