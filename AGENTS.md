...
## 4. Дорожная карта и ТЗ CRM (CRM_ROADMAP_SPEC.md)

Полный план и детальное техническое задание для внедрения 6 расширенных модулей CRM зафиксированы в файле **`CRM_ROADMAP_SPEC.md`**:
1. Автогенерация официальных ведомственных бланков (МВД / ФНС / МФЦ);
2. Интерактивная Канбан-доска (Drag & Drop воронка);
3. Система Telegram-оповещений о новых анкетах;
4. Модуль контроля сроков документов и повторных продаж (Deadlines);
5. Календарь записей на прием и сопровождение;
6. Ролевая модель доступа и разграничение прав (RBAC).

При реализации любых новых CRM-функций обязательно следовать архитектуре и соглашениям из `CRM_ROADMAP_SPEC.md`.
